...
<x-ui.card>
    <form action="{{ route('roles.store') }}" method="POST">
        ...
        <x-ui.input name="name" id="name" label="Nombre del Rol" required="true" value="{{ old('name') }}" placeholder="Ej: Auditor" containerClass="mb-4" oninput="this.value = this.value.replace(/[^a-zA-ZñÑáéíóúÁÉÍÓÚ\s]/g, '')" />
        ...
        <div class="text-end border-top pt-4">
            ...
            <x-ui.button type="submit" color="primary" icon="save" text="Guardar Rol" />
        </div>
    </form>
</x-ui.card>
@endsection
