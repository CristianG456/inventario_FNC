...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="fw-bold mb-0">Editar Rol: <span class="text-primary">{{ $role->name }}</span></h4>
    ...
    <div class="card-body">
        <form action="{{ route('roles.update', $role->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" required value="{{ old('name', $role->name) }}">
                @error('name')
            ...
            <div class="text-end border-top pt-4">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-save me-1"></i>Actualizar Rol
                </button>
            </div>
        </form>
    </div>
