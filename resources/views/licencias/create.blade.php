            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <select name="tipo_licencia" class="form-select @error('tipo_licencia') is-invalid @enderror" required>
                        ...
                        <option value="Vitalicia" {{ old('tipo_licencia') == 'Vitalicia' ? 'selected' : '' }}>Vitalicia</option>
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="cantidad_maxima" class="form-control @error('cantidad_maxima') is-invalid @enderror" value="{{ old('cantidad_maxima', 1) }}" min="1" required>
                ...
                <div class="col-md-4">
                    ...
                    <input type="date" name="fecha_inicio" class="form-control @error('fecha_inicio') is-invalid @enderror" value="{{ old('fecha_inicio') }}" min="{{ date('Y-m-d') }}">
