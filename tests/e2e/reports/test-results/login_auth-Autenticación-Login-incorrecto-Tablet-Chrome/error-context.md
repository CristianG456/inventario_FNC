...
- Name: login_auth.spec.js >> Autenticación >> Login incorrecto
- Location: tests\e2e\login_auth.spec.js:13:3
...
Locator: locator('text=Estas credenciales no coinciden')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Estas credenciales no coinciden')
...
- dialog "Revise los campos del formulario":
  ...
  - list:
    - listitem: Demasiados intentos de inicio de sesión. Por favor, inténtelo de nuevo en 25 segundos.
  - button "Entendido"
```
