...
- Name: activos.spec.js >> Activos >> Creación de activo con validaciones
- Location: tests\e2e\activos.spec.js:24:3
...
Locator: locator('.text-red-500, .invalid-feedback').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.text-red-500, .invalid-feedback').first()
