...
Call log:
  - Expect "toHaveURL" with timeout 5000ms
    14 × locator resolved to <html lang="es" class="swal2-shown swal2-height-auto">…</html>
...
- dialog "Revise los campos del formulario":
  ...
  - list:
    - listitem: Las credenciales proporcionadas no coinciden con nuestros registros.
  - button "Entendido"
```
